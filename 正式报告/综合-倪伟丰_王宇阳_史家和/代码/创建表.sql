...
-- 表10：INGREDIENT_ALLERGENS（食材过敏原关联表）
...
-- 表11：INGREDIENT_SUBSTITUTIONS（食材替代品关联表）
...
-- 表13：RATING_HELPFULNESS（评价有用性投票表）
...
-- 表15：COMMENT_HELPFULNESS（评论有用性投票表）
...
-- 表24：SHOPPING_LIST_ITEMS（购物清单项目表）
