...
\textbf{1. USERS表（用户表）}
\begin{longtable}{|L{3cm}|L{2.7cm}|c|L{2.2cm}|L{4cm}|}
\hline
...
\begin{longtable}{|L{3.5cm}|L{2.7cm}|c|L{2cm}|L{4cm}|}
\hline
\textbf{字段名} & \textbf{数据类型} & \textbf{非空} & \textbf{约束} & \textbf{说明} \\
\hline
...
\begin{longtable}{|L{3.5cm}|L{2.7cm}|c|L{2.2cm}|L{4cm}|}
\hline
\textbf{字段名} & \textbf{数据类型} & \textbf{非空} & \textbf{约束} & \textbf{说明} \\
\hline
