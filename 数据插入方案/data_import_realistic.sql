...
DROP SEQUENCE seq_rating_helpfulness;
DROP SEQUENCE seq_comments;
DROP SEQUENCE seq_comment_helpfulness;
...
CREATE SEQUENCE seq_rating_helpfulness START WITH 1 INCREMENT BY 1 NOCACHE ORDER;
CREATE SEQUENCE seq_comments START WITH 1 INCREMENT BY 1 NOCACHE ORDER;
CREATE SEQUENCE seq_comment_helpfulness START WITH 1 INCREMENT BY 1 NOCACHE ORDER;
...
CREATE SEQUENCE seq_user_activity_log START WITH 1 INCREMENT BY 1 NOCACHE ORDER;
...
PROMPT
PROMPT ========== AllRecipes 真实数据导入完成 ==========
PROMPT

SELECT '用户' label, COUNT(*) cnt FROM USERS
UNION ALL SELECT '食材', COUNT(*) FROM INGREDIENTS
UNION ALL SELECT '单位', COUNT(*) FROM UNITS
UNION ALL SELECT '过敏原', COUNT(*) FROM ALLERGENS
UNION ALL SELECT '标签', COUNT(*) FROM TAGS
UNION ALL SELECT '食谱', COUNT(*) FROM RECIPES
UNION ALL SELECT '烹饪步骤', COUNT(*) FROM COOKING_STEPS
UNION ALL SELECT '食谱食材', COUNT(*) FROM RECIPE_INGREDIENTS
UNION ALL SELECT '营养信息', COUNT(*) FROM NUTRITION_INFO
UNION ALL SELECT '食谱标签', COUNT(*) FROM RECIPE_TAGS
UNION ALL SELECT '食材过敏原', COUNT(*) FROM INGREDIENT_ALLERGENS
UNION ALL SELECT '评价', COUNT(*) FROM RATINGS
UNION ALL SELECT '评论', COUNT(*) FROM COMMENTS
UNION ALL SELECT '收藏', COUNT(*) FROM SAVED_RECIPES
UNION ALL SELECT '关注', COUNT(*) FROM FOLLOWERS
UNION ALL SELECT '用户过敏原', COUNT(*) FROM USER_ALLERGIES
UNION ALL SELECT '食谱清单', COUNT(*) FROM RECIPE_COLLECTIONS
UNION ALL SELECT '清单食谱', COUNT(*) FROM COLLECTION_RECIPES
UNION ALL SELECT '购物清单', COUNT(*) FROM SHOPPING_LISTS
UNION ALL SELECT '清单项目', COUNT(*) FROM SHOPPING_LIST_ITEMS
UNION ALL SELECT '膳食计划', COUNT(*) FROM MEAL_PLANS
UNION ALL SELECT '计划条目', COUNT(*) FROM MEAL_PLAN_ENTRIES
ORDER BY label;
